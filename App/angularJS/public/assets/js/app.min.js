...
"use strict";angular.module("myApp").controller("CustomerCtrl",["$scope","$http","consts","Msg","$state","Customer",function(t,e,r,o,s,u){var i=this;i.Customer={id:0,name:"",phone:"",address:""},i.Filter={id:"",name:""},i.lista={a:0},i.registerCustomer=function(){var e=u.registerCustomer(i.Customer.name,i.Customer.phone,i.Customer.address,1,4);e?(o.addSucess("Cliente inserido"),i.Customer.name="",i.Customer.phone="",i.Customer.address=""):o.addError("Houve um erro ao inserir o cliente"),t.contatoForm.$setPristine()},i.user={login:0,senha:1},t.maskTel="(99)99999-9999",i.searchCustomer=function(){var e=u.searchCustomer(i.Filter.id,i.Filter.name);i.lista=e.$$state},i.goToViewCustomer=function(e){s.go("viewCustomer",{id:e})},i.goToUpdateCustomer=function(e){s.go("updateCustomer",{id:e})},i.deleteCustomer=function(e,t){var r=u.deleteCustomer(e,t);r?(i.searchCustomer(),o.addSucess("Cliente deletado")):o.addError("Não foi possível excluir o cliente")}}]);
...
"use strict";angular.module("myApp").controller("LoginCtrl",["$http","Msg","Url","auth","$location","$window",function(o,n,a,r,e,t){var s=this;s.loginMode=!0,s.user={login:"",senha:""},s.Cadastro={name:"",telefone:"",login:"",senha:"",senhaConfirma:""},s.logar=function(){s.loginMode?r.login(s.user,function(o){o?n.addError("Erro ao logar"):(e.path("/"),n.addSucess("Bem-vindo","Logado com sucesso!"))}):d()},s.changeMode=function(){s.loginMode=!s.loginMode,s.Cadastro.name="",s.Cadastro.telefone="",s.Cadastro.login="",s.Cadastro.senha="",s.Cadastro.senhaConfirma="",s.user.login="",s.user.senha=""},s.logout=function(){var o=0<arguments.length&&void 0!==arguments[0]?arguments[0]:0;r.logout(function(){return e.path("/")}),e.path("/"),1==(o+=1)&&s.logout(o)};var d=function(){s.Cadastro.senha==s.Cadastro.senhaConfirma?r.signup(s.Cadastro,function(o){return o?n.addError(o):n.addSucess("Usuário cadastrdado!")}):n.addWarn("Senhas não conferem")};s.getUser=function(){var o=0<arguments.length&&void 0!==arguments[0]?arguments[0]:0;return r.getUser(o)}}]);
...
"use strict";angular.module("myApp").factory("Customer",["$http","consts","$q",function(a,s,n){var f=function(t,n,e,o,u){var r={idPerson:o||0,idCustomer:u||"",nome:t||"",telefone:n||"",endereco:e||""};return r};return{registerCustomer:function(o,u,r,c,i){return n(function(n,e){var t=new f(o,u,r,c,i);a.post(s.apiUrl+"/setCustomer",t).then(function(t){n(!0)}).catch(function(t){e(!1)})})},searchCustomer:function(o,u){return n(function(n,e){var t={id:o,name:u};a.post(s.apiUrl+"/getAllCustomers",t).then(function(t){n(t.data),console.log(t.data)}).catch(function(t){e(t)})})},viewCustomer:function(o){return n(function(n,e){var t={id:o};a.post(s.apiUrl+"/getCustomer",t).then(function(t){n(t.data[0])}).catch(function(t){e(t)})})},updateCustomer:function(t){return n(function(n,e){a.post(s.apiUrl+"/updateCustomer",t.value).then(function(t){n(!0)}).catch(function(t){e(!1)})})},deleteCustomer:function(o,u){return n(function(n,e){var t={idCustomer:o,pessoa:u};a.post(s.apiUrl+"/delCustomer",t).then(function(t){n(!0)}).catch(function(t){e(!1)})})},Customer:f}}]);
